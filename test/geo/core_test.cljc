...
(deftest test-parse-dms
  (are [string result]
      (is (= (geo/parse-dms string) result))
    "51° 28' 40.12\" n" 51.477811111111116
    "51° 28' 40.12\" N" 51.477811111111116
    "000° 00' 0.531\" w" -0.0001475
    "000° 00' 0.531\" W" -0.0001475
    "8° 44.707' S" -8.745116666666666
    "115° 9.019' E" 115.15031666666667))

(deftest test-parse-dms-point
  (are [s expected]
      (is (= (geo/parse-dms-point s) expected))
    "" nil
    "N W" nil
    "38° 41.324' N, 9° 21.58' W"
    (geo/point 4326 -9.359666666666667 38.68873333333333)
    "9° 21.58' W, 38° 41.324' N"
    (geo/point 4326 -9.359666666666667 38.68873333333333)))

(deftest test-centroid
  (are [points expected]
      (= (geo/centroid points) expected)
    [(geo/point 4326 -9.359666666666667 38.68873333333333)]
    (geo/point 4326 -9.359666666666667 38.68873333333333)
    [(geo/point 4326 -9.359666666666667 38.68873333333333)
     (geo/point 4326 -9.359666666666667 38.68873333333333)]
