...
;;     (is (= "SRID=4326;MULTIPOINT(10.0 40.0,40.0 30.0,20.0 20.0,30.0 10.0)" (geo/ewkt geo)))))
...
;;            (pr-str geo)))
;;     (is (= "SRID=4326;POLYGON((30.0 10.0,10.0 20.0,20.0 40.0,40.0 40.0,30.0 10.0))" (geo/ewkt geo))))
