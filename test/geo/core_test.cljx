...
(deftest test-line-string
  (let [geo (geo/line-string 4326 [30.0 10.0] [10.0 30.0] [40.0 40.0])]
    ...
    #+clj (is (= "#geo/line-string[4326 [[30.0 10.0] [10.0 30.0] [40.0 40.0]]]" (pr-str geo)))
    #+cljs (is (= "#geo/line-string[4326 [[30 10] [10 30] [40 40]]]" (pr-str geo)))
    #+clj (is (= "SRID=4326;LINESTRING(30.0 10.0,10.0 30.0,40.0 40.0)" (geo/ewkt geo)))
    #+cljs (is (= "SRID=4326;LINESTRING(30 10,10 30,40 40)" (geo/ewkt geo)))))
